...
const DoubtDeatils = ({activeClass}) => {
  console.log(activeClass);

  const handleClass=()=>{
     if(activeClass==="admission")
     return admission
    else if(activeClass==="certification")
    return certification
    else if(activeClass==="learning")
    return learning
    else if(activeClass==="payAfter")
    return payAfter
    else
    return placements
  }
   ...
   <>
    {
      ...
      handleClass().map((val)=>{
        return(
          <>
           <div className="row px-5 my-3 shadow p-3">
           <div className=" col-lg-12 pt-3 d-flex justify-content-between">
              <h5>{val.question}</h5>
            ...
            <div className="col-lg-12 collapse text-secondary fw-bold" id={val.id}>
              {val.answer}
              </div>
           </div>
